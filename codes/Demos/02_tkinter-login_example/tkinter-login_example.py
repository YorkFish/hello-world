# !/usr/bin/env python3
# coding:utf-8
# 原版：https://github.com/MorvanZhou/tutorials/blob/master/tkinterTUT/tk15_login_example/tk15_login_example.py
...
window = tk.Tk()
window.title("Welcome to YorkFish's site")
...
def usr_login():
    ...
    if usr_name in usrs_info:
        ...
        is_sin_up = tk.messagebox.askyesno(
            title="Welcome",
